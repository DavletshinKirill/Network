...
public class Initializer {
	...
	public void initial() {      
	    ...
	    AuthUserEntity user1 = new AuthUserEntity(true, "user1", "123456", "default.webp",
	    ...
	    AuthUserEntity user2 = new AuthUserEntity(true, "user2", "123456","default.webp",
	    ...
	    AuthUserEntity admin = new AuthUserEntity(true, "admin", "1234", "default.webp",
	    		Collections.singleton(new RoleUserEntity("admin", BaseRole.SUPER_USER)));
	    
	    authUserRepo.save(admin);
	    

	    AuthUserEntity admin1 = new AuthUserEntity(true, "admin1", "12345", "default.webp",
